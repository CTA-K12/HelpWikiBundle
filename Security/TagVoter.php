 ...
 * TagVoter.php file
 *
 * File that contains the help wiki tag voter class
 *
 * Licence MIT
 ...
 * 
 * @filesource /src/Mesd/HelpWikiBundle/Security/TagVoter.php
...
class TagVoter implements VoterInterface
{
    ...
    {
        $supportedClass = 'Mesd\HelpWikiBundle\Entity\Tag';

        return $supportedClass === $class || is_subclass_of($class, $supportedClass);
    }

    /**
     * @var \MesdHelpWikiBundle\Entity\Tag $tag
     */
    public function vote(TokenInterface $token, $tag, array $attributes)
    {
        // check if class of this object is supported by this voter
        if (!$this->supportsClass(get_class($tag))) {
        ...
        $permissions = $this->entityManager->getRepository('MesdHelpWikiBundle:Permission')->findByObject('TAG');
