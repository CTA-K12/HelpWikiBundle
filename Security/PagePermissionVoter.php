<?php
/**
 * PagePermissionVoter.php file
 *
 * File that contains the help wiki page permission voter class
 *
 * Licence MIT
 ...
 * 
 * @filesource /src/Mesd/HelpWikiBundle/Security/PagePermissionVoter.php
...
class PagePermissionVoter implements VoterInterface
{
    const CREATE   = 'CREATE';
    const VIEW     = 'VIEW';
    const EDIT     = 'EDIT';
    ...
    {
        $supportedClass = 'Mesd\HelpWikiBundle\Entity\PagePermission';
    ...
    public function vote(TokenInterface $token, $page, array $attributes)
    {
        ...
        $permissions = $this->entityManager->getRepository('MesdHelpWikiBundle:Permission')->findByObject('PAGEPERMISSION');
