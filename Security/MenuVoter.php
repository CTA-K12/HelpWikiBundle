 ...
 * 
 * @filesource /src/Mesd/HelpWikiBundle/Security/MenuVoter.php
...
class MenuVoter implements VoterInterface
{
    ...
    {
        $supportedClass = 'Mesd\HelpWikiBundle\Model\Menu';

        return $supportedClass === $class || is_subclass_of($class, $supportedClass);
    }

    /**
     * @var \MesdHelpWikiBundle\Model\Menu $menu
     */
    public function vote(TokenInterface $token, $menu, array $attributes)
    {
        // check if class of this object is supported by this voter
        if (!$this->supportsClass(get_class($menu))) {
        ...
        $permissions = $this->entityManager->getRepository('MesdHelpWikiBundle:Permission')->findByObject('MENU');
