<?php
/**
 * CommentVoter.php file
 *
 * File that contains the help wiki comment voter class
 *
 * Licence MIT
 ...
 * 
 * @filesource /src/Mesd/HelpWikiBundle/Security/CommentVoter.php
 ...
 * Comment Voter
 *
 * Leveraging the symfony voter interface, this service may abstain, grant, or
 * deny access to the comment entity based on permissions set in the permissions
 * entities. 
 *
 * @package    Mesd\HelpWikiBundle\Security
...
class CommentVoter implements VoterInterface
{
    ...
    {
        $supportedClass = 'Mesd\HelpWikiBundle\Entity\Comment';
    ...
    public function vote(TokenInterface $token, $page, array $attributes)
    {
        ...
        $permissions = $this->entityManager->getRepository('MesdHelpWikiBundle:Permission')->findByObject('COMMENT');
