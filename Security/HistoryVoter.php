<?php
/**
 * HistoryVoter.php file
 *
 * File that contains the help wiki history voter class
 *
 * Licence MIT
 ...
 * 
 * @filesource /src/Mesd/HelpWikiBundle/Security/HistoryVoter.php
...
class HistoryVoter implements VoterInterface
{
    const CREATE   = 'CREATE';
    const VIEW     = 'VIEW';
    const EDIT     = 'EDIT';
    ...
    {
        $supportedClass = 'Mesd\HelpWikiBundle\Entity\History';
    ...
    public function vote(TokenInterface $token, $page, array $attributes)
    {
        ...
        $permissions = $this->entityManager->getRepository('MesdHelpWikiBundle:Permission')->findByObject('HISTORY');
