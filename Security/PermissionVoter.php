<?php
/**
 * PermissionVoter.php file
 *
 * File that contains the help wiki permission voter class
 *
 * Licence MIT
 ...
 * 
 * @filesource /src/Mesd/HelpWikiBundle/Security/PermissionVoter.php
...
class PermissionVoter implements VoterInterface
{
    ...
    {
        $supportedClass = 'Mesd\HelpWikiBundle\Entity\Permission';
    ...
    public function vote(TokenInterface $token, $page, array $attributes)
    {
        ...
        $permissions = $this->entityManager->getRepository('MesdHelpWikiBundle:Permission')->findByObject('PERMISSION');
