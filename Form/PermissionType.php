 ...
 *
 * File that contains the help wiki tag form type form class
 *
 * Licence MIT
 ...
 * 
 * @filesource /src/Mesd/HelpWikiBundle/Form/PermissionType.php
 ...
 * Permission Type
 *
 * The help wiki permission form type
 *
 * @package    Mesd\HelpWikiBundle\Form
...
class PermissionType extends AbstractType
{
    ...
    {
        $builder
            ->add('object', 'mesd_help_wiki_object_type')
            ->add('type', 'mesd_help_wiki_permission_type')
            ->add('role')
        ;
    }
