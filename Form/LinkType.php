 ...
 * LinkType.php file
 *
 * File that contains the help wiki link form type class
 *
 * Licence MIT
 ...
 * 
 * @filesource /src/Mesd/HelpWikiBundle/Form/LinkType.php
...
class LinkType extends AbstractType
{
    ...
    {
        $builder
            ->add('routeAlias', 'mesd_help_wiki_routealias_type')
            ->add('page')
        ;
    }
